    ...
    <div>
      ...
      <section className="bg-linear-to-br from-[#e8f5ee] to-[#dceef7] py-24 px-6">
        <div className="max-w-7xl mx-auto max-w-3xl">
          ...
          >
            Fill in the form and one of our advisors will be in touch within
            48 hours to schedule your complimentary discovery session.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
            ...
            {!submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-white border border-sky/30 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-ocean-light transition-all appearance-none cursor-pointer"
                    >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-linear-to-r from-forest to-ocean-mid text-white py-4 rounded-xl font-bold hover:shadow-2xl hover:shadow-ocean/20 transition-all hover:-translate-y-0.5 active:scale-95 disabled:opacity-50"
                >
                  {loading
                    ? "Submitting..."
          ...
          >
            ...
            <p className="text-muted leading-relaxed text-lg font-light mb-12">
              We've helped partners take their first — and their boldest —
            ...
            <div className="mt-12 pt-12 border-t border-sky/20 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4 text-ocean">
                ...
                <a
                  href="https://linkedin.com/company/verdantia-global"
                  target="_blank"
